...
#define MOUNTED "/etc/mtab" //wonfee

#define _PATH_MOUNTED "/etc/mtab" //wonfee
...
// #define HAVE_STRUCT_STAT_ST_ATIM 1 //wonfee
...
// #define HAVE_UTIMENSAT 1 //wonfee
